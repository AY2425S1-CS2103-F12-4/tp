...
with(this){return _c('p',[_c('strong',[_v("Preconditions: StudentManagerPro is open.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Student profile has been created through the "),_c('u',[_v("addition of the student name(UC01).")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Guarantees:")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_v("Student to be removed exists in the system.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Guarantees:")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_v("Ui can be adjusted such that long names and phone numbers will not be truncated when added into StudentManagerPro.")]),_v(" "),_c('li',[_v("For commands with index, a specific error message can be added for missing index instead of the generic invalid command format error message so that users can easily find the error in their command.")]),_v(" "),_c('li',[_v("Instead of just showing an empty data file when a user adds an invalid format to the data file, an error message can be shown when the app is opened.")]),_v(" "),_c('li',[_v("Update help command to show a command summary instead of a link to the UG.")])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"edit"}},[_v("Edit"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#edit","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Edit command can be changed such that the student list is not unfiltered after the command is called.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Sort in descending order.")]),_v(" "),_c('li',[_v("Sort by more than one attribute at a time (sort by student class, and within each class sort by register number)")]),_v(" "),_c('li',[_v("Edit sort command to use simpler command for faster typing.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Exam Score can accept whole numbers and automatically convert them to one decimal point in the future to make it more intuitive for users.")]),_v(" "),_c('li',[_v("Exam Name can accept special characters that may be valid exam names to give users more input flexibility.")]),_v(" "),_c('li',[_v("Submission Status can be adjusted to be case-insensitive in the future to make it more convenient for users.")]),_v(" "),_c('li',[_v("Exam Score and Submission Status can be removed with a blank user input in their respective fields instead of “NIL” for consistency with other features.")]),_v(" "),_c('li',[_v("Include the ability to assign specific exams and submissions to selected groups and not automatically to all students, allowing for customized tests and assignments for different sets of students.")]),_v(" "),_c('li',[_v("Exams and Submissions can be automatically added for new students being added to the list, instead of having the user add them manually.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Adding attendance can be adjusted such that it does not show the entire unfiltered contact list every time it is added.")]),_v(" "),_c('li',[_v("“addAttendance” command can be changed to “trackAbsenteeism” to reduce confusion since the command can delete the records as well.")]),_v(" "),_c('li',[_v("As only dates in the current year are allowed when adding attendance, the command can be adjusted such that it only requires users to enter the date in the form of DD-MM.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Tue, 12 Nov 2024, 2:29:38 GMT+8]")])])])}
}];
