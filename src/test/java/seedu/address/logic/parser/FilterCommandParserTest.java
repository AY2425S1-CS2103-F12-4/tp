...
public class FilterCommandParserTest {
    ...
    void parse_invalidRegisterNumberFormat_throwsParseException() {
        // EP: invalid register number format
