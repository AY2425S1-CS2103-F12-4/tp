...
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. User enters invalid characters in the attendance data.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. System displays an error message asking for valid attendance format, with no special characters.\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("3a. User leaves the absent reason blank (indicating deletion of attendance).")]),_v(" "),_c('ul',[_c('li',[_v("3a1. System deletes the attendance record for that entry, and displays a confirmation message.\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("3b. User enters absent date in an invalid format.")]),_v(" "),_c('ul',[_c('li',[_v("3b1. System displays an error message asking for a valid absent date format.\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("3c. User enters absent reason in an invalid format.")]),_v(" "),_c('ul',[_c('li',[_v("3c1. System displays an error message asking for a valid absent reason format.\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("3d. User tries to add attendance for a student that does not exist.")]),_v(" "),_c('ul',[_c('li',[_v("3d1. System displays an error message notifying that the student does not exist in the system.\nUse case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("System: StudentManagerPro")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("User gives the command to add exam in StudentManagerPro.")]),_v(" "),_c('li',[_v("System validates the input's format.")]),_v(" "),_c('li',[_v("System validates the exam data.")]),_v(" "),_c('li',[_v("System adds the exam to every student currently in the system.")]),_v(" "),_c('li',[_v("System confirms the success by displaying a success message. Use case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("2a. User enters invalid characters in the exam name.\n"),_c('ul',[_c('li',[_v("2a1. System displays an error message asking for valid exam name format, with only alphanumeric characters and spaces. Use case ends.")])])]),_v(" "),_c('li',[_v("3a. User tries to add an exam that already exists in the system.\n"),_c('ul',[_c('li',[_v("3a1. System displays an error message telling the user that the exam already exists. Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("System: StudentManagerPro")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("User gives the command to add the score for a particular exam for a student in StudentManagerPro.")]),_v(" "),_c('li',[_v("System validates the input's format.")]),_v(" "),_c('li',[_v("System validates the exam data.")]),_v(" "),_c('li',[_v("System adds the exam score to the specified exam in the student's profile.")]),_v(" "),_c('li',[_v("System confirms the success by displaying a success message. Use case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("2a. User enters invalid characters in the exam name.\n"),_c('ul',[_c('li',[_v("2a1. System displays an error message asking for valid exam name format, with only alphanumeric characters and spaces. Use case ends.")])])]),_v(" "),_c('li',[_v("2b. User enters invalid characters in the exam score.\n"),_c('ul',[_c('li',[_v("2b1. System displays an error message asking for valid exam score format, an integer between 0 and 100. Use case ends.")])])]),_v(" "),_c('li',[_v("3a. User tries to add a score to an exam that does not exist.\n"),_c('ul',[_c('li',[_v("3a1. System displays an error message notifying that the exam does not exist in the system. Use case ends.")])])]),_v(" "),_c('li',[_v("3b. User tries to add a score to a student that does not exist.\n"),_c('ul',[_c('li',[_v("3b1. System displays an error message notifying that the student does not exist in the system. Use case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Fri, 1 Nov 2024, 15:09:52 GMT+8]")])])])}
}];
